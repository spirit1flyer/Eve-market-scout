...
from gui_window_utils import make_scrollable
from industry_ignore import IgnoreList, is_auto_hidden

# Reuse the shared formatting + colour helpers from the main Industry tab.
from gui_industry import (
...
class OwnedBlueprintsPanel:
    ...
    def _pending_structures(self) -> dict:
        ...
        registered as hubs."""
        try:
            from custom_stations import get_custom_hub_key
    ...
    def _register_structures(self):
        ...
        def work():
            from industry_blueprints import fetch_structure_meta
            from esi_structures import resolve_region_for_system
            from custom_stations import add_custom_station
            added, failed = [], []
    ...
    def _manage_ignored(self):
        from gui_industry import show_ignore_manager
        def changed():
            self._update_ignored_btn()
